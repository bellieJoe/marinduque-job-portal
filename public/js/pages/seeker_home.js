...
var devModule = {
  ...
  diffForHumans: function diffForHumans(date) {
    ...
    var currentDateTime = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.now();
    var diff = currentDateTime.diff(startDateTime, ['seconds', 'minutes', 'hours', 'days', 'weeks', 'months', 'years']);

    if (diff.years != 0) {
      if (diff.years > 1) {
        return "".concat(diff.years, " years ago");
      } else if (diff.months != 0) {
        return "".concat(diff.years, " year and ").concat(diff.months, " months ago");
      } else {
        return "".concat(diff.years, " year ago");
      }
    } else if (diff.months != 0) {
      return diff.months == 1 ? "".concat(diff.months, " month ago") : "".concat(diff.months, " months ago");
    } else if (diff.weeks != 0) {
      return diff.weeks == 1 ? "".concat(diff.weeks, " week ago") : "".concat(diff.weeks, " weeks ago");
    } else if (diff.days != 0) {
      return diff.days == 1 ? "".concat(diff.days, " day ago") : "".concat(diff.days, " days ago");
    } else if (diff.hours != 0) {
      return diff.hours == 1 ? "".concat(diff.hours, " hour ago") : "".concat(diff.hours, " hours ago");
    } else if (diff.minutes != 0) {
      return diff.minutes == 1 ? "".concat(diff.minutes, " minute ago") : "".concat(diff.minutes, " minutes ago");
    } else {
      return diff.seconds == 1 ? "".concat(diff.seconds, " second ago") : "".concat(diff.seconds, " seconds ago");
    }
...
/***/ "./resources/js/pages/seeker_home.js":
/*!*******************************************!*\
  !*** ./resources/js/pages/seeker_home.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _dev_module_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dev_module.js */ "./resources/js/dev_module.js");
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()("#loading").css("display", "none");
new Vue({
  el: "#seeker-home",
  data: {
    savedJobs: null,
    ...
    jobApplications: [],
    toggle: null,
    devModule: _dev_module_js__WEBPACK_IMPORTED_MODULE_2__.default,
    // loaders
  ...
  methods: {
    ...
    deleteSavedJob: function deleteSavedJob(saved_job_id) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()("#loading").css("display", "initial");
      jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
        url: " /seeker/home/delete-saved-job/".concat(saved_job_id),
        method: 'post'
      }).fail(function (res) {
        // console.log(res)
        location.href = "/error";
      }).done(function (res) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()("#loading").css("display", "none"); // console.log(res)

        _this2.getSavedJobs();
      });
    },
    viewJob: function viewJob(job_id) {
      location.href = "job/".concat(job_id);
    },
    toggleJobs: function toggleJobs(a) {
      if (a == "suggestions") {
    ...
    filterJobApplications: function filterJobApplications(a) {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/pages/seeker_home.js");
