...
var _require = __webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/chart.esm.js"),
    Chart = _require.Chart,
    registerables = _require.registerables;

Chart.register.apply(Chart, _toConsumableArray(registerables));

var UserDistChart = function UserDistChart() {
  var ctx = document.getElementById("userDistChart").getContext("2d");
...
var userTimelineChart = function userTimelineChart() {
  var ctx = document.getElementById("userTimelineChart").getContext("2d");
  var DATA_COUNT = 7;
  var NUMBER_CFG = {
    count: DATA_COUNT,
    min: -100,
